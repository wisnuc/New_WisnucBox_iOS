...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        self.backgroundColor = UICOLOR_RGB(0xf2f2f6);
        [self setupSubviews];
    }
    return self;
}
...
- (void)setupSubviews {
    ...
    _photoButton.titleLabel.textColor = UICOLOR_RGB(0x8e8e93);
    ...
    _takePicButton.titleLabel.textColor = UICOLOR_RGB(0x8e8e93);
