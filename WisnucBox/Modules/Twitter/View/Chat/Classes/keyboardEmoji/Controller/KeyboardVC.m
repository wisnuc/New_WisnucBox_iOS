...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        lineView.backgroundColor = UICOLOR_RGB(0xe1e1e5);
        ...
        CGFloat itemW = 62;
        CGFloat itemH = 37;
        UIImage *image = [UIImage lh_imageWithColor:UICOLOR_RGB(0xf2f2f6)];
        ...
        [sendButotn setTitleColor:UICOLOR_RGB(0xffffff) forState:UIControlStateNormal];
