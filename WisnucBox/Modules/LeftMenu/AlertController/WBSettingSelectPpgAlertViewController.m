//
//  WBSettingSelectPpgAlertViewController.m
//  WisnucBox
//
...
@interface WBSettingSelectPpgAlertViewController ()
...
@implementation WBSettingSelectPpgAlertViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    NSLog(@"%@",_typeString);
    if ([_typeString isEqualToString:[NSString stringWithFormat:@"%d",PpgTypeCreatNewTask]]) {
        [self.creatNewTaskRadioButton setSelected:YES];
    }else if ([_typeString isEqualToString:[NSString stringWithFormat:@"%d", PpgTypeUpload]]){
