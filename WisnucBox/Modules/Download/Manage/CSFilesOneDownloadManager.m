...
- (void)beginDownloadTask:(CSDownloadTask*)downloadTask
    ...
    if (begin)
    {
        [_souceArray addObject:downloadTask];
        begin();
    }
...
- (void)cancelAllDownloadTask{
    @weaky(self)
    [_souceArray enumerateObjectsUsingBlock:^(CSDownloadTask *obj, NSUInteger idx, BOOL * _Nonnull stop) {
        [weak_self cancelOneDownloadTaskWith:obj];
    }];
    [_souceArray removeAllObjects];
}
