...
//    divisionView.backgroundColor = LC_ACTION_SHEET_COLOR(150, 150, 150);
    divisionView.backgroundColor = LINECOLOR;
...
-(void)jy_appendButtonWithTitles:(NSArray *)buttonTitles{
    self.otherButtonTitles = [self.otherButtonTitles arrayByAddingObjectsFromArray:buttonTitles];
    [self.tableView reloadData];
    [self updateBottomView];
    [self updateTableView];
}
